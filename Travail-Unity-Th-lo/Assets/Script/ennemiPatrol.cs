...
public class ennemiPatrol : MonoBehaviour
{
    ...
    // enregistre le rigidbody et le sprite de l'ennemi
    //  transforme aussi les valeurs de limite Droite et Gauche en coordonnées réelles
    void Start() {
    ...
    // visualiser le chemin de l'ennemi dans l'éditeur
    void OnDrawGizmos() {
    ...
    private void OnCollisionEnter2D(Collision2D collision)
{
    ...
    {
        // Déclenche l'animation d'attaque de l'ennemi
        if (enemyScript != null)
            enemyScript.Attack();

        // Inflige les dégâts au player 
